...
import { GEMINI_API_KEY, GEMINI_MODEL_NAME } from '../config/config';
...
export const describeImage = async (imageUriOrBase64, targetLang = 'en') => {
  try {
    ...
    const prompt = targetLang === 'hi'
      ...
      : "I am blind. Describe my surroundings clearly and shortly within less than 50 words, focusing on anything that could affect my movement or safety — such as people, objects, or obstacles. Include only relevant details in my immediate environment that help me form a vivid and pleasant mental image, so I can navigate comfortably and independently. Keep it calm and simple. Avoid distractions, but make my journey feel engaging and enjoyable.";
